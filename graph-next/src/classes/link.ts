...
export default class LinkC {
    ...
    draw(c: CanvasRenderingContext2D, color: string, theme: string, selectedObject: SelectedObjectType, caretVisible: boolean, inCanvas: boolean) {
        ...
        strokeThemeBased(c, color, theme);
        ...
        if (stuff.hasCircle) {
            ...
            drawText(c, this.text, textX, textY, textAngle, this.fontSize, true, selectedObject === this, caretVisible, inCanvas);
        } else {
            ...
            drawText(c, this.text, textX, textY, textAngle + this.lineAngleAdjust, this.fontSize, true, selectedObject === this, caretVisible, inCanvas);
        }
    };
